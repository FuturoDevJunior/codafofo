...
export default function CategoryCard({ 
  ...
  return (
    <Card className={`hover:shadow-2xl from-white group transform border-2 border-vitale-primary/20 bg-gradient-to-br to-vitale-primary/5 text-center transition-all duration-300 hover:-translate-y-2 hover:border-vitale-primary/50 ${className}`}>
      <CardHeader className="pb-4">
        <div className={`mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br ${config.bgColor} transition-transform duration-300 group-hover:scale-110`}>
