  ...
  useEffect(() => {
    ...
    const createSkipLinks = () => {
      ...
      skipLinks.forEach(link => {
        ...
        skipLink.className = 'skip-link sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:bg-vitale-primary focus:text-white focus:px-4 focus:py-2 focus:rounded-lg focus:no-underline';
