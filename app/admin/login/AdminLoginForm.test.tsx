...
describe('AdminLoginForm', () => {
  ...
  it('deve alternar visibilidade da senha', async () => {
    ...
    const toggleButton = toggleButtons.find(btn => (btn as HTMLButtonElement).type === 'button' && btn !== screen.getByRole('button', { name: /entrar/i }));
  ...
  it('deve ter gradiente de fundo', () => {
    ...
    expect(mainContainer).toHaveClass('bg-gradient-to-br', 'from-vitale-primary/10', 'to-vitale-secondary/10');
  });
